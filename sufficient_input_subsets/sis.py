...
def sis_collection(f,
    ...
    Args:
      ...
      initial_mask: Optional. Boolean array (or type convertible to array) of
        ...
        broadcastable masks.)
      max_len: Optional. Break prematurely after gathering max_len SIS's even
        if there are potentially more SIS available.
    ...
    while True and (len(all_sis) < max_len or max_len == -1):
